...
public class MyInsertTest
{
    ...
    public void TestInsertIgnore()
    {
        ...
        con.SetupCommand(cmd =>
        {
            cmd.Executing = c => Assert.Equal("INSERT IGNORE INTO Data (Id, Name) VALUES (@p0, @p1)", c.CommandText);
            cmd.SetupResult(0);
        });
    ...
    public void TestInsertOrUpdate()
    {
        ...
        con.SetupCommand(cmd =>
        {
            cmd.Executing = c => Assert.Equal("INSERT INTO MultiKey (Key1, Key2, Type, Name) VALUES (@p0, @p1, @p2, @p3) ON DUPLICATE KEY UPDATE Type = @p2, Name = @p3", c.CommandText);
            cmd.SetupResult(0);
        });
