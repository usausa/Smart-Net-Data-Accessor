...
// ([Name] / [Key] / [AutoGenerated] / [Ignore]). Both generators enumerate entity properties and build
...
internal static class ColumnAttributeHelper
{
    ...
    private const string AutoGeneratedAttributeFq = "Smart.Data.Accessor.Attributes.AutoGeneratedAttribute";
    ...
    public static ColumnAttributeInfo Read(IPropertySymbol prop)
    {
        ...
        return new ColumnAttributeInfo(name ?? prop.Name, isKey, isAutoGenerated, isIgnored);
    }
}
...
internal readonly record struct ColumnAttributeInfo(string ColumnName, bool IsKey, bool IsAutoGenerated, bool IsIgnored);
