...
public sealed class PgSelectAttribute : MethodAttribute
{
    ...
    public PgSelectAttribute(string table)
        : this(table, null)
    {
    }

    public PgSelectAttribute(Type type)
        : this(null, type)
    {
    }

    private PgSelectAttribute(string? table, Type? type)
