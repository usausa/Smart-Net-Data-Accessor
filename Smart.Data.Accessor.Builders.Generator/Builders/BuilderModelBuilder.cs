...
internal static class BuilderModelBuilder
{
        ...
        CancellationToken ct)
    {
        ...
        var accessibility = AccessibilityText(container.DeclaredAccessibility);
        ...
        Location? location)
    {
        ...
        if (handler is not null && MappingResolver.TryGetConverterTypes(handler, out var convDb, out var convClr))
        {
