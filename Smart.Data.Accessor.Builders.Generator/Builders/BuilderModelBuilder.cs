...
internal static class BuilderModelBuilder
{
        ...
        Location? location)
    {
        ...
        else if (handler is null && MappingResolver.TryGetTypeMap(prop.Type, typeMaps, out var info))
        {
            dbTypeExpr = info.DbTypeExpr;
            size = info.Size;
        }

        var isNullableValueType = prop.Type is INamedTypeSymbol nt && nt.IsGenericType &&
